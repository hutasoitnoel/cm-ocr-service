...
var _require = require('tesseract.js'),
...
dotenv.config();
var parseKTP = require('./helpers/parseKTP');
var parseSIM = require('./helpers/parseSIM');
var app = express();
app.use(cors({
...
app.post('/upload', upload.single('image'), /*#__PURE__*/function () {
  var _ref = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee(req, res) {
    var processedBuffer, worker, response, payload, ktpResult, simResult;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        ...
        case 2:
          ...
          _context.next = 6;
          return sharp(req.file.buffer).grayscale().threshold(150).resize({
            width: 1200
          }).toBuffer();
        case 6:
          processedBuffer = _context.sent;
          _context.next = 9;
        ...
        case 12:
          _context.next = 14;
          return worker.recognize(processedBuffer);
        case 14:
          response = _context.sent;
          ktpResult = parseKTP(response.data.text);
          simResult = parseSIM(response.data.text);
